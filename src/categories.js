...
export const categories={
 motorcycle:{label:'오토바이',documents:true,minPrice:1000000,fields:[f('brand','제조사',true,motorcycleBrands),f('model','모델명',true),year,f('type','차량 종류',true),km,f('capacity','배기량',false,['50cc 미만','50~100cc','100~175cc','175cc 초과','잘 모르겠음']),country,guarantee]},
