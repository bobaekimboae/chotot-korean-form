...
const motorcycleBrands=['AIMA','ALLY','Anbico','Aprilia','Asama','Avent','Bazan','Before All','Benelli','BMW','BMX','Bridgestone','Brixton','CFMoto','CR&S','Daelim','Datbike','Detech','Dibao','DKBike','Ducati','Espero (Detech)','Euro Reibel','Giant','GPX','Halim','Harley Davidson','Hitasa','HK Bike','Honda','Husqvarna','Hyosung','Hyundai','JVC','Kawasaki','Keeway','Kengo','Kingda','KTM','Kumatsu','Kymco','Lambretta','Lifan','Lihaze','Malaguti','MBI','Moto Guzzi','Motor Thái','MV Agusta','Nijia','Nioshima','NIU','Norton','Osakar','Pega','Peugeot','Piaggio','RebelUSA','Regal Raptor','Royal Enfield','Sachs','Sanda','Selex Motors','Sonsu','Sunra','Suzika','Suzuki','SYM','TAILG','Taya','Triumph','Vento','Victoria','Victory','Việt Thái','VinFast','Visitor','Xiaomi','Xmen','Yadea','Yamaha','Zongshen','Zontes','Zoomer'];
const truckBrands=['Chenglong','Chiến Thắng','Cửu Long','Daewoo','Dongben','Dongfeng','Đô Thành','FAW','Forcia','Fusin','Fuso','Hino','Hoa Mai','Howo','Hyundai','Isuzu','JAC','Kamaz','KIA','Mitsubishi','Samco','Shacman','Sinotruk','Suzuki','SYM','TATA','Teraco','Thaco','Thành Hưng','TMT','Trường Giang','UD Trucks','Veam','Vinamotor','Vinaxuki','기타 제조사'];
...
export const categories={
 motorcycle:{label:'오토바이',documents:true,minPrice:1000000,fields:[f('brand','제조사',true,motorcycleBrands),f('model','모델명',true),year,f('type','차량 종류',true,['스쿠터','기어식 오토바이','전기 오토바이','수동 클러치 / 모터사이클']),km,f('capacity','배기량',false,['50cc 미만','50~100cc','100~175cc','175cc 초과','잘 모르겠음']),country,guarantee]},
 ...
 truck:{label:'트럭 / 덤프트럭',documents:false,minPrice:5000000,fields:[f('brand','트럭 제조사',true,truckBrands),f('payload','적재량',true,['1톤 미만',...Array.from({length:17},(_,i)=>(i+2)+'톤'),'18톤 초과']),year,f('fuel','연료',true,fuel),country,color,km]},
 ...
 other:{label:'기타 차량',documents:false,minPrice:1,fields:[f('type','차량 종류',true,['특수 목적 차량','기타','여객차 / 버스']),year,f('fuel','연료',false,fuel),country,color,guarantee]},
