...
test('parts do not validate or export fields left in other categories',()=>{const form={condition:'중고',partType:'브레이크',origin:'대한민국',brand:'Honda',model:'PCX',payload:'5톤',km:'-1'};assert.deepEqual(detailErrors('parts',form),{});assert.deepEqual(currentDetails('parts',form),{partType:'브레이크',origin:'대한민국'});});
